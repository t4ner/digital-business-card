        ...
        <div className="flex-col lg:flex lg:flex-row lg:space-x-5 container w-[90%]">
          <div className="rounded-md flex flex-col p-5 gap-y-3 text-center basis-1/3 shadow-xl">
            ...
            <p className="text-[15px] text-zinc-800">
              ecoQr ile iletişim bilgilerinizi akılda kalıcı bir şekilde
          ...
          <div className="rounded-md flex flex-col p-5 gap-y-3 text-center basis-1/3 shadow-xl">
            ...
            <p className="text-[15px]">
              ...
              etkilerinizi azaltmanın zamanı. Çevre dostu ecoQr, farkınızı
          ...
          <div className="rounded-md flex flex-col p-5 gap-y-3 text-center basis-1/3 shadow-xl">
            ...
            <p className="text-[15px]">
              ecoQr, ihtiyacınız olan tek kartvizit! Tüm iletişim bilgilerinizi
              sınırsız bir şekilde paylaşırsınız. Kartvizitleriniz bir daha asla
              bitmez.
            </p>
          </div>
        </div>
