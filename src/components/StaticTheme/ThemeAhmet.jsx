...
import logo from "/staticThemePhoto/ahmet.jpeg";
import logo1 from "/staticThemePhoto/ahmet2.jpeg";
import logo2 from "/staticThemePhoto/ahmet3.jpeg";
      ...
      <div className=" bg-white rounded-xl md:w-1/3 flex flex-col items-center justify-center space-y-1  shadow-[0_0px_50px_-15px_rgba(0,0,0,.9)] shadow-green-600">
        <div className="flex items-center space-x-10">
          ...
          <div className="text-center">
            <h3 className="font-semibold ">AHMET YAKAR</h3>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 ">
          <div>
            <a href="https://www.instagram.com/ahmetyakar.ay/" target="_blank">
              <img src={instagram} className="w-16" />
            </a>
          </div>
          <div>
            <a
              href="https://api.whatsapp.com/send?phone=05555555555"
              target="_blank"
          ...
          <div>
            <a href="mailto:ahmetyakar@gmail.com" target="_blank">
        ...
        <div className="w-full space-y-2 px-2 ">
          ...
          <div className="w-full h-60">
            <img
              src={logo2}
              className="h-full object-cover object-right w-full rounded-md"
            />
          </div>
          <div className="w-full h-60">
