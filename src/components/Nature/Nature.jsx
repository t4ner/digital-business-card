...
function Nature() {
  return (
    <div className="w-full md:w-4/5 mx-auto mt-20 flex-col md:flex md:flex-row items-center justify-center gap-5 ">
      <div class="relative mx-auto flex items-center justify-center flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-80 md:w-96">
        <div class="relative h-[221px] mx-4 -mt-6 overflow-hidden text-white shadow-lg bg-clip-border rounded-xl bg-blue-gray-500 shadow-blue-gray-500/40">
          <img src={nature1} alt="card-image" className="object-cover" />
        </div>
        <div class="p-6">
          <p class="block text-sm md:text-base antialiased leading-relaxed text-inherit font-medium text-zinc-500">
      ...
      <div class="relative mx-auto flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-80 md:w-96 pt-10 md:pt-0">
        ...
        <div class="p-6">
          <p class="block text-sm md:text-base antialiased font-medium text-zinc-500 leading-relaxed text-inherit">
